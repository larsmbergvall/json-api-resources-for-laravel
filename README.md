...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/json-api-resources-for-laravel.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/json-api-resources-for-laravel)
...
```bash
php artisan vendor:publish --tag="json-api-resources-for-laravel-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="json-api-resources-for-laravel-config"
```
...
```bash
php artisan vendor:publish --tag="json-api-resources-for-laravel-views"
```

## Usage

```php
$jsonApiResourcesForLaravel = new Larsmbergvall\JsonApiResourcesForLaravel();
echo $jsonApiResourcesForLaravel->echoPhrase('Hello, Larsmbergvall!');
```
